...
(
	...
	FK_PJ INT DEFAULT NULL FOREIGN KEY REFERENCES FORN_PJ(ID) ,
	FK_PF INT DEFAULT NULL FOREIGN KEY REFERENCES FORN_PF(ID) 
); 
SELECT * FROM TELEFONES_ADICIONAIS;
...
SELECT PJ.ID,
	   ...
	   WHERE PJ.FK_EMP = @EMP AND PJ.ID = @ID;
	   RETURN;
END;
...
IF @FkPj = '' set @FkPj = null
IF @FkPf = '' set @FkPf = null
